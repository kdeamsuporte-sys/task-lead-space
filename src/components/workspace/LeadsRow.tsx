  ...
  return (
    <section>
      <div className="mb-4 flex flex-wrap items-end justify-between gap-3">
        <div>
          <div className="text-[11px] font-semibold uppercase tracking-[0.2em] text-primary/80">Inbox comercial</div>
          <div className="mt-1 flex items-baseline gap-3">
            <h2 className="text-2xl font-bold tracking-tight">Novos Leads</h2>
