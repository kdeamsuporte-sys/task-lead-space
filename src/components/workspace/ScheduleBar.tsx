...
export function ScheduleBar() {
  ...
  return (
    <section className="glass-elevated relative overflow-hidden rounded-3xl p-5">
      {/* radial accent */}
      ...
      <div className="relative">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="text-[11px] font-semibold uppercase tracking-[0.2em] text-primary/80">Hoje no comercial</span>
              ...
              <h2 className="text-lg font-bold tracking-tight">28 de Março · sexta-feira</h2>
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="flex h-10 items-center gap-2 rounded-full bg-primary px-4 text-xs font-semibold text-primary-foreground shadow-[0_10px_30px_-12px_oklch(0.72_0.205_38_/_0.7)] hover:bg-primary/90">
